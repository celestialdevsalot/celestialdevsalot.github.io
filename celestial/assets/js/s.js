...
const presets = {
  ...
  nt: { title: "New Tab", favicon: "/celestial/assets/img/logo.png" },
};
...
function switchCloak() {
  if (document.hidden) {
    ...
    updateFavicon("/celestial/assets/img/logo.png");
  }
}
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  toggle.onchange = function () {
    if (toggle.checked) {
      ...
      updateFavicon(
        localStorage.getItem("savedFavicon") || "/celestial/assets/img/logo.png"
      );
    }
  };
});
